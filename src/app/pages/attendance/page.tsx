...
const AttendanceContent: React.FC = () => {
  ...
  const StatusButton = ({
    ...
    const borderColor = isNoClass ? RED : BLUE;
    const activeColor = isNoClass ? RED : BLUE;
    const activeFg = isNoClass ? "white" : GOLD;
    const inactiveFg = isNoClass ? RED : BLUE;
    ...
    return (
      <button
        ...
        style={{
          ...
          boxShadow: active ? `0 6px 16px ${isNoClass ? "rgba(220,38,38,0.25)" : "rgba(25,25,112,0.25)"}` : "none",
        }}
      >
        {label}
      </button>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <StatusButton
                      label="No Class"
                      active={cls.status === "No Class"}
                      onClick={() => markAttendance(cls.id, "No Class")}
                      isNoClass={true}
                    />
                  </div>
                </div>
                ...
                >
                  <span>
                    Selected: <b style={{ color: cls.status === "No Class" ? RED : BLUE }}>{cls.status}</b>
                  </span>
